    ...
    >
      <div className="flex-col">
        <div className="flex py-1">
          <div className="h-6 w-6 -ml-0.5 mr-1 my-1">
          <svg
            className={`fill-current ${alertStyle.icon}`}
          ...
          <button
            type="button"
            className={`ms-auto -mr-1.5 ml-2 -my-1.5  rounded-lg focus:ring-2  inline-flex items-center justify-center h-8 w-8 dark:bg-gray-800 dark:hover:bg-gray-700 p-2 ${alertStyle.closeIcon}`}
